...
namespace ImGui
{
    ...
    IMGUI_API bool          Renderingsubtab(const char* icon, bool selected);
    IMGUI_API bool          Renderingtab(const char* icon2, const char* icon, const char* label, bool selected);
    ...
    IMGUI_API bool          MenuChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags, float rounding);
    ...
    IMGUI_API void          ColorTooltip(const char* text, ImColor color, float alpha);
