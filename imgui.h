...
namespace ImGui
{
    ...
    IMGUI_API bool          KeyBind(const char* label, KeyBind_t* k, ImGuiKeyBindFlags flags = 0);
    IMGUI_API bool          MenuChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0, float rounding = 5);
    ...
    IMGUI_API bool          ItemsToolTipBeginKeyBind(const char* name, bool hover = false, ImVec2 pos = ImVec2(0, 0));
...
struct ImDrawList
{
    ...
    IMGUI_API void AddInvertedRectFilled(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float rounding, ImDrawCornerFlags rounding_corners = ImDrawCornerFlags_All);
    IMGUI_API void PathInvertedRect(const ImVec2& a, const ImVec2& b, ImU32 col, float rounding, ImDrawCornerFlags rounding_corners = ImDrawCornerFlags_All);
